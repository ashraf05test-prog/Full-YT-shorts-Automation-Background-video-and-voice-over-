...
app.post('/api/ai-generate', async (req, res) => {
  ...
  try {
    ...
    if (service === 'gemini') {
      const r = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=${apiKey || process.env.GEMINI_API_KEY}`, {
